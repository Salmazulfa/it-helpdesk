                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <h2>Detail Permohonan Pengembangan Aplikasi Server</h2>
                        </div>
                            ...
                            <div class="table-responsive" style="overflow-x:hidden;">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="deskripsi_app" id="deskripsi_app"
                                                type="text" maxlength="100" value="{{ $pengembanganApp->nama_app }}" disabled></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label class="required tebal">Pengembang Aplikasi</label>
                                            <input name="pengembang_app" id="pengembang_app" type="text"
                                                class="form-control" maxlength="100" value="{{ $pengembanganApp->pengembang_app }}" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label class="required tebal">Status Terintegrasi</label>
                                            <input name="status_terintegrasi" id="status_terintegrasi" type="text"
                                                class="form-control" maxlength="50" value="{{ $pengembanganApp->status_terintegrasi }}" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="aplikasi_terintegrasi" id="aplikasi_terintegrasi" type="text"
                                                class="form-control" maxlength="100" value="{{ $pengembanganApp->aplikasi_terintegrasi }}" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label class="required tebal">Fitur Pengembangan</label>
                                            <input name="fitur_pengembangan" id="fitur_pengembangan" type="text"
                                                class="form-control" maxlength="5" value="{{ $pengembanganApp->fitur_pengembangan }}" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <embed src="{{ asset('storage/'.$pengembanganApp->surat_permohonan) }}" width="100%" height="800px"/>
                                        </div>
                                ...
                                <div class="modal-footer">                                    
                                    <div class="col-3">
                                        ...
                                        <a class="btn btn-info btn-block" href="/PermohonanPengembanganAplikasi">Kembali</a>
                                    </div>
                                </div>
                                <!-- submit button -->
                            @endsection
