                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <h2>Layanan Aduan Permasalahan WIFI RW</h2>
                            
                            {{-- BUTTON --}}
                            <a class="btn btn-info col-md-2" style="margin-bottom:20px" href="/LaporanWifi/create"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    <li>Dalam Antrian&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                                        &nbsp;{{ $wifi->tgl_antri }}</li>
                                                    <li>Sedang Diproses&nbsp;&nbsp;: &nbsp;{{ $wifi->tgl_proses }}
                                                    </li>
                                                    <li>Selesai Diproses&nbsp;&nbsp;&nbsp;:
                                                        &nbsp;{{ $wifi->tgl_selesai }}</li>
                                                </ul>
                                            ...
                                            <td><a class="btn btn-info btn-m"
                                                href="/LayananWifi/detail/{{ $wifi->id }}"><i
