                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="materi" id="materi" type="text" class="form-control" maxlength="100" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Tujuan Kegiatan</label>
                                            <input name="tujuan_kegiatan" id="tujuan_kegiatan" type="text" class="form-control" maxlength="100" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Tanggal Kegiatan</label>
                                            <input name="tgl_kegiatan" id="tgl_kegiatan" type="date" class="form-control" maxlength="5" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Upload Surat Permohonan</label>
                                            <input type="file" name="surat_permohonan" class="form-control" id="surat_permohonan" required>
                                        </div>
