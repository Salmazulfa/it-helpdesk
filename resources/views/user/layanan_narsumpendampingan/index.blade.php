                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <h2>Permohonan Narasumber dan Pendampingan</h2>
                            {{-- BUTTON --}}
                            <a class="btn btn-info col-md-2" style="margin-bottom:20px" href="/PermohonanNarsumPendampingan/create"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($narasumber as $narasumber)
                                        <tr>
                                            ...
                                            <td><ul>
                                                <li>Dalam Antrian&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;{{ $narasumber->tgl_antri }}</li>
                                                <li>Sedang Diproses&nbsp;&nbsp;: &nbsp;{{ $narasumber->tgl_proses }}</li>
                                                <li>Selesai Diproses&nbsp;&nbsp;&nbsp;: &nbsp;{{ $narasumber->tgl_selesai }}</li>
                                            </ul>
                                            </td>
                                    <td><a class="btn btn-info btn-m"
                                        href="/PermohonanNarsumPendampingan/detail/{{ $narasumber->id}}"><i
