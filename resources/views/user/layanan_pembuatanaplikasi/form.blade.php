                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <h2>Form Permohonan Pembuatan Aplikasi</h2>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Tuliskan latar belakang disini . . ." name="latarbelakang" id="latarbelakang" required></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Nama Aplikasi</label>
                                            <input name="nama_app" id="nama_app" type="text" class="form-control" maxlength="50" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="status_terintegrasi" id="status_terintegrasi" type="text" class="form-control" maxlength="50" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Nama Aplikasi yang Terintegrasi</label>
                                            <input name="aplikasi_terintegrasi" id="aplikasi_terintegrasi" type="text" class="form-control" maxlength="100" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Kebutuhan Fitur</label>
                                            <textarea class="form-control" placeholder="Tuliskan fitur-fitur disini . . ." name="kebutuhan_fitur" id="kebutuhan_fitur" required></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Tanggal Penggunaan</label>
                                            <input name="tgl_penggunaan" id="tgl_penggunaan" type="date" class="form-control" maxlength="5" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Upload Proses Bisnis</label>
                                            <input type="file" class="form-control" name="proses_bisnis" id="proses_bisnis" required>
                                        </div>
