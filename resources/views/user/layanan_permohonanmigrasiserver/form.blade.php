                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="instansi" id="instansi" type="text" class="form-control tebal"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Tuliskan deskripsi disini . . ." name="deskripsi_app" id="deskripsi_app"
                                                required></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="tgl_penggunaan" id="tgl_penggunaan" type="date"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control"
                                                name="surat_permohonan"id="surat_permohonan" required>
                                        </div>
