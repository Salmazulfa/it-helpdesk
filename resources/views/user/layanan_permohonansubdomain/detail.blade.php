                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <h2>Detail Data Permohonan Subdomain</h2>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="instansi" id="instansi" type="text" class="form-control" maxlength="50" value="{{ $user->perangkat->instansi }}"
                                                disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="deskripsi_app" id="deskripsi_app" type="text" maxlength="100" value="{{ $subdomain->deskripsi_app }}" disabled></input>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="pengembang_app" id="pengembang_app" type="text" class="form-control" maxlength="50"
                                                value="{{ $subdomain->pengembang_app }}" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="status_terintegrasi" id="status_terintegrasi" name="st" type="text" class="form-control" maxlength="50"
                                                value="{{ $subdomain->status_terintegrasi }}" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="aplikasi_terintegrasi" id="aplikasi_terintegrasi" type="text" class="form-control" maxlength="50"
                                                value="{{ $subdomain->aplikasi_terintegrasi }}" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label class="required tebal">Tanggal</label>
                                            <input name="tgl_penggunaan" id="tgl_penggunaan" type="text" class="form-control" maxlength="50"
                                                value="{{ $subdomain->tgl_penggunaan }}" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label class="required tebal">Subdomain</label>
                                            <input name="subdomain" id="subdomain" type="text" class="form-control" maxlength="100" value="{{ $subdomain->subdomain }}" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="info_server" id="info_server" type="text" class="form-control" maxlength="100"
                                                value="{{ $subdomain->info_server }}" disabled>
                                        </div>
                                ...
                                <!-- main content area end -->
                                 ...
                                 <div class="modal-footer">                                    
                                    <div class="col-3">
                                        ...
                                        <a class="btn btn-info btn-block" href="/PermohonanSubdomain">Kembali</a>
                                    </div>
                                </div>
                                <!-- submit button -->
@endsection
