@extends('admin.masterdata_show.kelurahan.layouts.main')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <h2>Data Kelurahan Kota Malang</h2>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button data-bs-toggle="modal" data-bs-target="#ModalEdit"
                                                    data-kecamatan_id="{{ $kel->kecamatan->kecamatan }}"
                                                    data-kelurahan="{{ $kel->kelurahan }}"
                                                    class="btn btn-success btn-m"><i class="bi bi-pencil-square"></i>
                                                    Update</button>
                                                <a class="btn btn-danger btn-m"
                                                    href="/ViewKelurahan/delete/{{ $kel->id }}"
