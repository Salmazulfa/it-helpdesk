    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="/ViewKecamatan">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Kecamatan</label>
                            <input name="kecamatan" type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                                placeholder="Nama Kecamatan" id="kecamatan">
                                @error('kecamatan')
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Submit" name="kecamatanbaru">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div id="ModalEdit" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" action="/ViewKecamatan/update/{{ $kec->id }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Kecamatan</label>
                            <input name="kecamatan" type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                                placeholder="Nama Kecamatan" id="kecamatan" value="">
                        </div>
