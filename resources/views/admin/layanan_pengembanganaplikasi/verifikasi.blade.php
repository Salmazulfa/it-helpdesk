...
@section('container')
    <div class="main-content-inner">
        ...
        <form method="post" enctype="multipart/form-data"
            action="/ViewPengembanganAplikasi/update/{{ $pengembanganApp->id }}">
            @csrf
            {{-- PESAN ALERT --}}
            <br>
            ...
            <div class="row mt-8 mb-5">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <h2>Formulir Permohonan Pengembangan Aplikasi</h2><br>
                            </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input name="instansi" id="instansi" type="text"
                                                    class="form-control tebal" maxlength="50"
                                                    value="{{ $pengembanganApp->instansi }}" disabled>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="nama_app" id="nama_app" type="text" class="form-control"
                                                    maxlength="100" value="{{ $pengembanganApp->nama_app }}" disabled>
                                            </div>

                                            <div class="form-group">
                                                <label class="required">Latar Belakang Pengembangan</label>
                                                <textarea class="form-control" name="latarbelakang" id="latarbelakang" value="{{ $pengembanganApp->latarbelakang }}"
                                                    disabled>{{ $pengembanganApp->latarbelakang }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="pengembang_app" id="pengembang_app" type="text"
                                                    ...
                                                    value="{{ $pengembanganApp->pengembang_app }}" disabled>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="status_terintegrasi" id="status_terintegrasi" name="st"
                                                    type="text" class="form-control" maxlength="50"
                                                    value="{{ $pengembanganApp->status_terintegrasi }}" disabled>
                                            </div>

                                            <div class="form-group">
                                                <label class="required">Nama Aplikasi Terintegrasi</label>
                                                <input name="aplikasi_terintegrasi" id="aplikasi_terintegrasi"
                                                    type="text" class="form-control" maxlength="50"
                                                    value="{{ $pengembanganApp->aplikasi_terintegrasi }}" disabled>
                                            </div>

                                            <div class="form-group">
                                                <label class="required">Fitur Pengembangan</label>
                                                <textarea class="form-control" name="kebutuhan_fitur" id="kebutuhan_fitur"
                                                    value="{{ $pengembanganApp->fitur_pengembangan }}" disabled>{{ $pengembanganApp->fitur_pengembangan }}</textarea>
                                            </div>

                                            <div class="form-group">
                                                <label class="required">Surat Permohonan</label><br>
                                                <input type="hidden" class="form-control"
                                                    name="surat_permohonan"id="surat_permohonan" disabled>
                                                <embed src="{{ asset('storage/' . $pengembanganApp->surat_permohonan) }}"
                                                    width="100%" height="800px" />
                                            </div>
                                            
                                            <div class="form-group">
                                                <input type="hidden" name="statusdb" id="statusdb"
                                                    value="{{ $pengembanganApp->status }}" class="form-control" disabled>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p>( Status Saat Ini → &nbsp;<b>{{ $pengembanganApp->status }}</b> )
                                                <p>
                                                    ...
                                                    <input type="hidden" class="form-control mt-3" id="tgl_proses"
                                                        name="tgl_proses" value="{{ $pengembanganApp->tgl_proses }}">
                                                    ...
                                                    <input type="hidden" class="form-control mt-3" id="tgl_selesai"
                                                        name="tgl_selesai" value="{{ $pengembanganApp->tgl_selesai }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <div class="col-3">
                                            ...
                                            <a class="btn btn-light btn-block"
                                                href="/form/KelolaPengembanganAplikasi">Cancel</a>
                                        </div>
                                    </div>
                                    <!-- submit button -->
                                </div>
