@extends('layanan_pembuatanaplikasi.layouts.main')
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Tuliskan latar belakang disini . . ." id="floatingTextarea" required></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Nama Aplikasi</label>
                                            <input name="pa" type="text" class="form-control" maxlength="50" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="st" type="text" class="form-control" maxlength="50" required>
                                        </div>

                                        <div class="form-group">
                                            <label class="required">Nama Aplikasi yang Terintegrasi</label>
                                            <input name="at" type="text" class="form-control" maxlength="100" required>
                                        </div>
